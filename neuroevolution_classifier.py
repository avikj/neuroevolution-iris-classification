...
def crossover_networks(mommy_params, daddy_params, train_X, train_y):
  child_m = {
    'W_1': np.copy(mommy_params['W_1']),
    'b_1': np.copy(mommy_params['b_1']),
    'W_2': np.copy(mommy_params['W_2']),
    'b_2': np.copy(mommy_params['b_2'])
  }
  child_d = {
    'W_1': np.copy(daddy_params['W_1']),
    'b_1': np.copy(daddy_params['b_1']),
    'W_2': np.copy(daddy_params['W_2']),
    'b_2': np.copy(daddy_params['b_2'])
  }
  rand = np.random.rand()
...
# return two children from
def crossover_layer_biases(mommy_b, daddy_b):
  pass
